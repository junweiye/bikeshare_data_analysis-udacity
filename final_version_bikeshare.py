...
CITY_DATA = { 'chicago': '/Users/junwei/Desktop/Data_analyst/作业/bikeshare-new/chicago.csv',
              'new york city': '/Users/junwei/Desktop/Data_analyst/作业/bikeshare-new/new_york_city.csv',
              'washington': '/Users/junwei/Desktop/Data_analyst/作业/bikeshare-new/washington.csv' }
...
def get_filters():
    ...
    #该表达式会在196行，def main():
    #    while True:
    #        city, month, day = get_filters()出现ValueError: too many values to unpack (expected 3)，猜测是因为def main()
    #函数需要获取city,month,day三个赋值，但是在第一个return city获取完赋值后就结束了获取，导致赋值数量不够三个)
